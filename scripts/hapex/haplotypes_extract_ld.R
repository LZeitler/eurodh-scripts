...
filename <- '260419_step6_red_v4_BU_DH.vcf' # adjust for each population and type

runall <- function(filename){

#(outname <- paste0("haplocount/hapseq_55k_50kb_v4_",substr(filename, 17,21),".txt")) # 600k data
outname <- paste0("haplocount/hapseq_55k_v4_ld_",substr(filename, 21,25),".txt") # 55k data

dat <- fread(filename, data.table=T)
map <- fread('../map/ogut_v4_bed_breakpoints.bed', data.table = T, col.names = c('chr','start','stop'))
chroms <- 1:10
...
runall('260419_step6_red_v4_BU_DH.vcf')
runall('260419_step6_red_v4_BU_LR.vcf')
runall('260419_step6_red_v4_GB_DH.vcf')
runall('260419_step6_red_v4_GB_LR.vcf')
runall('260419_step6_red_v4_RT_DH.vcf')
runall('260419_step6_red_v4_RT_LR.vcf')
runall('260419_step6_red_v4_SC_DH.vcf')
runall('260419_step6_red_v4_SC_LR.vcf')
runall('260419_step6_red_v4_SF_DH.vcf')
runall('260419_step6_red_v4_SF_LR.vcf')
